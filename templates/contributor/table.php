...
<?php foreach ($data as $r) { ?>
            <tr>
                <td><?php echo_safe($r->contributor_id); ?></td>
                <td><?php echo_safe($r->name); ?></td>
                <td><a href="<?php echo $base_url . "?action=edit&id={$r->contributor_id}"; ?>">
                    Edit</a></td>
                <td><a 
                    href="<?php echo $base_url . "?action=delete&id={$r->contributor_id}"; ?>">
                    Delete</a></td>
            </tr>
